...
def test_share_threat_intelligence():
    ...
    node1 = AliveLoopNode(position=(0, 0), velocity=(0, 0), initial_energy=10.0, node_id=1)
    node2 = AliveLoopNode(position=(1, 0), velocity=(0, 0), initial_energy=10.0, node_id=2)
    node3 = AliveLoopNode(position=(2, 0), velocity=(0, 0), initial_energy=10.0, node_id=3)
    ...
    notified = node1.share_threat_intelligence([node2, node3], pattern, confidence=0.9)
