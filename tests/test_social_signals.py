...
class TestSocialSignal:
    ...
    def test_signal_types(self):
        ...
        for sig_type in types:
            signal = SocialSignal(
                content="test", signal_type=sig_type, urgency=0.5, source_id=1
            )
    ...
    def test_signal_urgency_range(self):
        ...
        signal_low = SocialSignal(
            content="test", signal_type="memory", urgency=0.0, source_id=1
        )
        assert signal_low.urgency == 0.0

        signal_high = SocialSignal(
            content="test", signal_type="warning", urgency=1.0, source_id=1
        )
        assert signal_high.urgency == 1.0

        signal_mid = SocialSignal(
            content="test", signal_type="query", urgency=0.5, source_id=1
        )
    ...
    def test_signal_idempotency_key(self):
        ...
        signal1 = SocialSignal(
            content="test", signal_type="memory", urgency=0.5, source_id=1
        )
    ...
    def test_signal_retry_tracking(self):
        ...
        signal = SocialSignal(
            content="test", signal_type="query", urgency=0.7, source_id=1
        )
    ...
    def test_signal_content_types(self):
        ...
        signal_num = SocialSignal(
            content=42, signal_type="resource", urgency=0.3, source_id=1
        )
